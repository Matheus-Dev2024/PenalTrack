<?php
return [
    'nome' => env('APP_NAME', 'Zeus'), //nome do sistema
    'codigo' => 52, //Código deste sistema na tabela de produção "sistema" no schema segurança. Não deixe como 35 no seu projeto
